...
let rec build_fun idents e pos= 
  match idents with
  | [] -> e
  | (i,t)::id' -> node pos (Fun(i,t,build_fun id' e pos))

let build_funrec f tp idents e pos= 
  match idents with
  | [] -> failwith "no arguments passed"
  | (i,t) :: id' -> node pos (Funrec(f,i,t,tp,build_fun id' e pos))
%}
...
mexpr:
    ...
    | FUN;
      ...
      ARR; e = mexpr
        { node $loc (Fun(x, tp, e)) }
    | FUNREC; f = IDENT;
      LPAREN; x = ident_list ; RPAREN;
      COLON; tp2 = type_simpl; ARR; e = mexpr
        { (build_funrec f tp2 x e $loc) }
    | e = expr
        { e }
    ;
...
ident_list:
    | i = IDENT ; COLON ; t = type_expr { [(i,t)]}
    | i = IDENT ; COLON ; t = type_expr ; e = ident_list { (i,t) :: e } 
    ;
...
class Player(object):
    def __init__(self, command, name=""):
        ...
        kwargs = {'bufsize' : 1, 'shell' : False, 'text' : True,
...
def play(game_class, num_games, p0cmd, p1cmd,
    ...
    def play_game():
        ...
        try:
            ...
            _ = p[cur_player].expect('RDY', timeout= remaining_time)
            ...
            reset(kill=True)
            print(f'timeout { 1 - timeout_winner}', file = sys.stderr)
            return timeout_result[timeout_winner]

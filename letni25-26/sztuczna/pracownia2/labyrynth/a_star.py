...
def heuristic(n,m,lab, pts, distances, solve_1_precomp):
    #for every point we want to calculate the manhattan distance to the closest of the points
    # h1 = max(distances[p] for p in pts) #distance of the farthest point to end point
    # h1 <= h2 always
    h2 = max(solve_1_precomp[p] for p in pts)

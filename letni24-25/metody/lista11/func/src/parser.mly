...
app_expr:
    | ISINT; e1 = base_expr { Is (TInt, e1) }
    | ISBOOL; e1 = base_expr { Is (TBool, e1) }
    | ISUNIT; e1 = base_expr { Is (TUnit, e1) }
    | ISPAIR; e1 = base_expr { Is (TPair, e1) }
    | ISFUN; e1 = base_expr { Is (TFun, e1) }
